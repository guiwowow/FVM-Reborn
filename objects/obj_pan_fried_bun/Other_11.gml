// 用户事件1 - 发射子弹
var inst = instance_create_depth(x+40, y-95, depth-500, obj_panfriedbun_bullet)
...
inst.shape = shape
if shape == 1{
	inst.sprite_index = spr_panfriedbun_bullet_1
}
if shape == 2{
	inst.sprite_index = spr_panfriedbun_bullet_2
}