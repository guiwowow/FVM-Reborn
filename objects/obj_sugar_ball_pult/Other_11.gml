// 用户事件1 - 发射子弹
var inst = instance_create_depth(x-40, y-125, depth-500, obj_sugarballpult_bullet)
if shape == 1{
	inst.sprite_index = spr_sugar_ball_pult_bullet_1
}
if shape == 2{
...
if (target_instance != noone && instance_exists(target_instance)) {
	...
	inst.row = target_instance.grid_row
