...
summon_timer ++
if summon_timer mod 720 == 719 && body_count < 3{
	var body = instance_create_depth(x,y,-800,obj_thor_body)
	body.timer = timer
...
switch state{
	...
	case BOSS_STATE.SKILL2:
		if timer <= 13 * 5 - 1{
			...
			if hp > maxhp * hurt_rate{
				...
				image_index = floor((timer-65)/5) mod 10 + 10
			}
		}
	...
	case BOSS_STATE.SKILL3:
		...
		if hp > maxhp * hurt_rate{
			...
			image_index = floor(timer/5) mod 22 + 22
		}
