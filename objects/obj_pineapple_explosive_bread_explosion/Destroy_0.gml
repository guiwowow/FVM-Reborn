// Inherit the parent event
	...
	with (obj_enemy_parent) {
		...
		if (point_distance(x, y, _x, _y) < _range &&( 
		(grid_row >= other.grid_row-1&&grid_row <= other.grid_row+1)||
		(grid_row >= other.grid_row-2&&grid_row <= other.grid_row+2 && other.shape >= 2))) {
